...
const DatenschutzCopy = () => (
    <div>
        ...
        <p>
            ...
            gesetzlichen Pflichten bzw. Serviceversprechen zum Teil externer
            Dienstleister. Eine Auflistung der von uns eingesetzten
            Auftragnehmer und Dienstleister, zu denen nicht nur vorübergehende
            Geschäftsbeziehungen bestehen, können Sie der Übersicht im Anhang
            entnehmen.
        </p>
        ...
        <p>
            ...
            Versicherungsfalls überprüfen und bei Bedarf ergänzen zu können,
            kann im dafür erforderlichen Umfang ein Austausch von
        ...
        <p>
            ...
            Bestellung ausführen zu können. Wir speichern diese Daten in unseren
        ...
        <p>
            ...
            Google in den USA übertragen und dort gespeichert. Aufgrund der
            Aktivierung der IP-Anonymisierung auf diesen Webseiten, wird Ihre
        ...
        <p>
            ...
            Cherry Ave., San Bruno, CA 94066, USA. Wenn Sie eine Seite mit dem
            YouTube-Plugin besuchen, wird eine Verbindung zu Servern von Youtube
            hergestellt. Dabei wird Youtube mitgeteilt, welche Seiten Sie
            besuchen. Wenn Sie in Ihrem Youtube-Account eingeloggt sind, kann
            Youtube Ihr Surfverhalten Ihnen persönlich zuzuordnen. Dies
            verhindern Sie, indem Sie sich vorher aus Ihrem Youtube-Account
            ausloggen.
        </p>
        <p>
        ...
        <p>
            ...
            Versicherungsverbunds auf Gegenseitigkeit, die untereinander auch
            als Auftragnehmer und Kooperationspartner tätig werden und eine
            zentrale Datenverarbeitung vornehmen.
        </p>
        <p>
            Für jede Datenverarbeitung, Datenerhebung und Datenübermittlung wird
            im Einzelfall geprüft, ob und wenn ja, welcher
            Dienstleister/Auftragnehmer beauftragt wird. Keinesfalls erfolgt
            eine automatische Datenübermittlung an jeden der in der Liste
            genannten Dienstleister.
        </p>
        <br />
        <p>
            Unternehmen des Continentale Versicherungsverbunds auf
        ...
        <StyledTable>
            <tbody>
                ...
                <tr>
                    ...
                    <td valign="top">
                        Vertrags- und Schaden-/Leistungsbearbeitung, Interner
                        Service (Empfang, Telefonservice, Postservice inklusive
                        Scannen und Zuordnen von Eingangspost), zentrale
                        Datenverarbeitung
                    </td>
        ...
        <StyledTable>
            <tbody>
                <tr>
                    <td valign="top">
                        <b>
                            Kategorien von Auftragnehmern und
                ...
                <tr>
                    ...
                    <td valign="top">
                        Erstellung von Gutachten, Gebäudewertermittlung,
                        Beratungs- dienstleistungen, Belegprüfung,
                        Schadenbehebung
                    </td>
                    <td valign="top">Ja, teilweise</td>
                </tr>
                ...
                <tr>
                    ...
                    <td valign="top">
                        Schadenfeststellung, Schadenbehebung,
                        Restwertermittlung, Fahrzeugvermietung
                    </td>
                    <td valign="top">Nein</td>
                </tr>
                <tr>
        ...
        <p>
            Mannheimer Versicherung AG <b>I </b>Augustaanlage 66 <b>I </b>68165
            Mannheim Telefon: 06 21. 4 57 80 00 <b>I </b>E-Mail:
        ...
        <p>
            ...
            Rechnungsstellung. Angaben zum Schaden/Leistungsfall benötigen wir
            etwa, um prüfen zu können, ob ein Versicherungsfall eingetreten und
            wie hoch der Schaden/Leistungsfall ist.
            <br />
            <b>
        ...
        <p>
            ...
            Erstellung von versicherungsspezifischen Statistiken, z. B. für die
            Entwicklung neuer Tarife oder zur Erfüllung aufsichtsrechtlicher
            Vorgaben. Die Daten aller mit der Mannheimer Versicherung AG
            bestehenden Verträge nutzen wir für eine Betrachtung der gesamten
            Kundenbeziehung, beispielsweise zur Beratung hinsichtlich einer
            Vertragsanpassung, -ergänzung oder für umfassende
            Auskunftserteilungen.
        </p>
        <p>
            ...
            DS-GVO. Soweit dafür besondere Kategorien personenbezogener Daten
            (z. B. Ihre Gesundheitsdaten bei Abschluss eines
            Unfallversicherungsvertrages) erforderlich sind, holen wir Ihre
            Einwilligung nach Art. 9 Abs. 2 lit. a) i. V. m. Art. 7 DS-GVO ein.
            Erstellen wir Statistiken mit diesen Datenkategorien, erfolgt dies
            auf Grundlage von Art. 9 Abs. 2 lit. j) DS-GVO i.V. m. § 27 BDSG.
        </p>
        <p>
            Ihre Daten verarbeiten wir auch, um berechtigte Interessen von uns
            oder von Dritten zu wahren (Art. 6 Abs. 1 lit. f) DS-GVO). Dies kann
        ...
        <p>
            ...
            wir Datenanalysen zur Erkennung von Hinweisen,
            <br />
        ...
        <p>
            Sollten wir Ihre personenbezogenen Daten für einen oben nicht
            genannten Zweck verarbeiten wollen, werden wir Sie darüber zuvor
            informieren, soweit Sie nicht bereits über diese Informationen
            verfügen (Art. 13 Abs. 4 DS-GVO) oder eine Information gesetzlich
        ...
        <p>
            ...
            verbundenen Unternehmen zentral wahr. Soweit ein
            ...
            Exkasso oder zur gemeinsamen Postbearbeitung zentral oder dezentral
            durch ein oder mehrere Unternehmen der Gruppe verarbeitet werden.
            Die Unternehmen, die eine zentrale Datenverarbeitung vornehmen,
        ...
        <h5>4.2 Externe Dienstleister</h5>
        <p>
            Wir bedienen uns zur Erfüllung unserer vertraglichen und
            gesetzlichen Pflichten zum Teil externer Dienstleister. Eine
            Auflistung der von uns eingesetzten Auftragnehmer und Dienstleister,
            zu denen nicht nur vorübergehende Geschäftsbeziehungen bestehen,
            sowie der Unternehmen unserer Gruppe, die an einer zentralisierten
            Datenverarbeitung teilnehmen, können Sie jeweils aktuell unseren
            vollständigen Datenschutz- hinweisen auf unserer Internetseite unter
            www.mannheimer.de/datenschutz entnehmen.
        </p>
        <h5>4.3 Weitere Empfänger</h5>
        <p>
            Darüber hinaus können wir Ihre personenbezogenen Daten an weitere
            Empfänger übermitteln, wie etwa an Behörden zur Erfüllung
            gesetzlicher Mitteilungspflichten (z. B. Sozialversicherungsträger,
            Finanzbehörden, Straßenverkehrsämter, Kraftfahrtbundesamt oder
            Strafverfolgungsbehörden).
        </p>
        <h5>4.4 Vermittler</h5>
        <p>
            Soweit Sie hinsichtlich Ihres Versicherungsvertrags von einem
            Vermittler betreut werden, verarbeitet Ihr Vermittler die zum
            Abschluss und zur Durchführung des Vertrags benötigten Antrags-,
            Vertrags- und Schaden-/Leistungsfalldaten. Auch übermittelt unser
            Unternehmen diese Daten an die Sie betreuenden Vermittler, soweit
            diese die Informationen zu Ihrer Betreuung und Beratung in Ihren
            Versicherungs- und Finanz- angelegenheiten benötigen.
        </p>
        <h5>4.5 Datenaustausch mit Versicherern</h5>
        <p>
            Um Ihre Angaben bei Abschluss des Versicherungsvertrages (z. B. zur
            Angabe von vorvertraglichen Versicherungsverläufen) bzw. Ihre
        ...
        <h5>4.6 Rückversicherer</h5>
        <p>
            Von uns übernommene Risiken versichern wir bei spezialisierten
            Versicherungsunternehmen (Rückversicherer). Dafür kann es
            erforderlich sein, Ihre Vertrags- und ggf.
            Schaden-/Leistungsfalldaten an die Rückversicherer zu übermitteln,
            damit diese sich ein eigenes Bild über das Risiko oder den
        ...
        <p>
            Wir übermitteln bei Abschluss des Versicherungsvertrages oder im
            Rahmen der Schadenbearbeitung durch eine HIS-Anfrage Objektdaten
            (Fahrzeugidentifikationsdaten oder Adresse des Gebäudes) sowie
            Angaben zu Ihrer Person (Name, Vorname, Geburtsdatum, Anschrift,
            frühere Anschriften) an die informa HIS GmbH (informa HIS GmbH,
            Kreuzberger Ring 68, 65205 Wiesbaden, www.informa-his.de). Die
            informa HIS GmbH überprüft anhand dieser Daten, ob zu Ihrer Person
            und/oder zu Ihrem Objekt im „Hinweis- und Informationssystem der
            Versicherungswirtschaft“ (HIS) Informationen gespeichert sind, die
            auf ein erhöhtes Risiko oder Unregelmäßigkeiten in einem
            Versicherungsfall hindeuten können. Solche Informationen können nur
            aufgrund einer früheren Meldung eines Versicherungsunternehmens an
            das HIS vorliegen (HIS-Einmeldung), über
        </p>
        <p>
            die Sie ggf. von dem einmeldenden Versicherungsunternehmen gesondert
            informiert worden sind. Daten, die aufgrund einer HIS-Einmeldung im
            HIS gespeichert sind, werden von der informa HIS GmbH an uns, das
            anfragende Versicherungsunternehmen, übermittelt.
        </p>
        <h5>4.8 Datenübermittlung an Auskunfteien</h5>
        <p>
            Wir übermitteln die im Rahmen der Begründung dieses
            Vertragsverhältnisses erhobenen personenbezogene Daten zur
            Einschätzung des Zahlungsausfallrisikos an die infoscore Consumer
            Data GmbH, Rheinstraße 99, 76532 Baden-Baden.
        </p>
        <p>
            Rechtsgrundlagen dieser Übermittlungen sind Artikel 6 Absatz 1 lit.
            b) und Artikel 6 Absatz 1 lit. f) der Datenschutz-Grundverordnung
            (DS-GVO). Übermittlungen auf der Grundlage von Artikel 6 Absatz 1
            lit. f) DS-GVO dürfen nur erfolgen, soweit dies zur Wahrung unserer
            berechtigten Interessen erforderlich ist und nicht die Interessen
            oder Grundrechte und Grundfreiheiten der betroffenen Person, die den
            Schutz personen- bezogener Daten erfordern, überwiegen.
        </p>
        <p>
            Die Auskunfteien verarbeiten die erhaltenen Daten und verwenden sie
            auch zum Zwecke der Profilbildung (Scoring), um ihren
            ...
            natürlichen Personen zu geben. Nähere Informationen zur Tätigkeit
            der oben genannten Auskunfteien können dem Informationsblatt der
            infoscore Consumer Data GmbH unter
            https://finance.arvato.com/de/verbraucher/selbstauskunft.html
            entnommen werden.
        </p>
        <h5>4.9 Bonitätsauskunft zur Wahrung berechtigter Interessen</h5>
        <p>
        ...
        <h5>4.10 Adressaktualisierung</h5>
        <p>
            Zur Aktualisierung unserer Adressbestände erhalten wir Adressdaten
            auftragsbezogen von der Deutsche Post Adress GmbH &amp; Co. KG, Am
            Anger 33, 33332 Gütersloh. Erhalten wir zu Ihrer Person eine neue
            Anschrift, ändern wir Ihre Adressdaten bei uns entsprechend. Eine
            gesonderte Information zu derartigen Adressänderungen erfolgt nicht.
        </p>
        <h4>5. Automatisierte Einzelfallentscheidungen</h4>
        <p>
            Auf Basis Ihrer Angaben zum Risiko, zu denen wir Sie bei
            Antragstellung befragen, entscheiden wir unter Umständen
            vollautomatisiert über das Zustandekommen oder die Kündigung des
            Vertrages, mögliche Risikoausschlüsse oder über die Höhe der von
            Ihnen zu zahlenden Versicherungsprämie.
        </p>
        <p>
            Die vollautomatisierten Entscheidungen beruhen auf von uns vorher
            festgelegten Regeln und Gewichtung der Informationen. Die Regeln
            richten sich unter anderem nach unseren Annahmegrundsätzen,
            gesetzlichen und vertraglichen Regelungen sowie den vereinbarten
            Tarifen. Des Weiteren kommen versicherungsmathematische Kriterien
            und Kalkulationen je nach Entscheidung zur Anwendung.
        </p>
        <p>
            Wenn beispielsweise im Zusammenhang mit dem Abschluss eines
            Versicherungsvertrages eine Bonitätsprüfung erfolgt, entscheidet
            unser System in bestimmten Fällen aufgrund der erhaltenen
            Informationen vollautomatisiert über das Zustandekommen des
            Vertrages, mögliche Risikoausschlüsse oder über Modalitäten zu der
            von Ihnen zu zahlenden Versicherungsprämie. Wir nutzen die
            automatisierte Entscheidung im Zusammenhang mit der Bonitätsprüfung,
            um uns und die Versichertengemeinschaft vor möglichen
            Zahlungsausfällen und deren Folgen zu schützen.
        </p>
        <p>
            Aufgrund Ihrer Angaben zum Versicherungsfall und der zu Ihrem
            Vertrag gespeicherten Daten (z. B. zum Versicherungsumfang,
            Selbstbehalts- vereinbarungen, Prämienzahlung) sowie ggf. von
            Dritten hierzu erhaltenen Informationen entscheiden wir unter
            Umständen vollautomatisiert über unsere Leistungspflicht sowie der
            Höhe der Leistungspflicht, Bonifikationen und
            Zusatzdienstleistungen. Die vollautomatisierten Entscheidungen
            beruhen auf den zuvor beschriebenen Regeln.
        </p>
        <p>
            Soweit wir eine vollautomatisierte Einzelfallentscheidung in den
            zuvor beschriebenen Fällen ohne menschliche Einflussnahme
            abschließend durchgeführt haben, werden Sie mit unserer Mitteilung
            der Entscheidung darauf hingewiesen. Sie haben das Recht, zum
            Beispiel über unsere Service-Hotline, weitere Informationen sowie
            eine Erklärung zu dieser Entscheidung zu erhalten und sie durch
            einen Mitarbeiter von uns überprüfen zu lassen. Dieses Recht besteht
            nicht, wenn Ihrem Begehren vollumfänglich stattgegeben wurde.
            Vollautomatisierte Einzelfallentscheidungen, die ein Mitarbeiter von
            uns für seine abschließende Entscheidung nur zu einem
            untergeordneten Teil berücksichtigt hat, sind ebenfalls nicht
            betroffen.
        </p>
        <h4>6. Datenübermittlung in ein Drittland</h4>
        <p>
            ...
            Versicherungsfall außerhalb des Europäischen Wirtschaftsraums (EWR)
            kann es zu diesem Zweck erforderlich sein, dass wir oder unsere
            Dienstleister in Ihrem Interesse Ihre Daten an Dienstleister
            außerhalb des Europäischen Wirtschaftsraums (EWR) geben müssen. Wir
            und unsere Dienstleister übermitteln Ihre Daten planmäßig nur, wenn
            diesem Drittland durch die EU-Kommission
        </p>
        <p>
        ...
        <h4>7. Dauer der Speicherung Ihrer Daten </h4>
        <p>
            Wir löschen Ihre personenbezogenen Daten, sobald sie für die oben
            genannten Zwecke nicht mehr erforderlich sind. Dabei kann es
            vorkommen, dass personenbezogene Daten für die Zeit aufbewahrt
            ...
            soweit wir dazu gesetzlich verpflichtet sind. Entsprechende
            Nachweis- und Aufbewahrungspflichten ergeben sich unter anderem aus
            dem Handelsgesetzbuch, der Abgaben- ordnung und dem
            Geldwäschegesetz. Die Speicherfristen betragen danach bis zu zehn
            Jahren.
        </p>
        <h4>8. Betroffenenrechte</h4>
        <p>
            Sie können unter der o. g. Adresse Auskunft über die zu Ihrer Person
            gespeicherten Daten verlangen. Darüber hinaus können Sie unter
            bestimmten Voraussetzungen die Berichtigung oder die Löschung Ihrer
        ...
        <p>
            <b>
                Sie haben das Recht, einer Verarbeitung Ihrer personenbezogenen
                Daten zu Zwecken der Direktwerbung zu widersprechen. Verarbeiten
                wir Ihre Daten zur Wahrung berechtigter Interessen, können Sie
                dieser Verarbeitung widersprechen, wenn sich aus Ihrer
        ...
        <h4>9. Aktualisierung der Datenschutzhinweise</h4>
        <p>
            Telefon: 0711. 615541-0
            <br />
            Telefax: 07 11. 61 55 41-15
            <br /> poststelle@lfdi.bwl.de
        </p>
        <p>
            Diese Datenschutzhinweise können aufgrund von Änderungen, z. B. der
            gesetzlichen Bestimmungen, zu einem späteren Zeitpunkt angepasst
            werden. Eine jeweils aktuelle Fassung dieser Hinweise sowie der
            Dienstleister, zu denen nicht nur vorübergehende
            Geschäftsbeziehungen bestehen, erhalten Sie unter{" "}
            <a href="https://www.mannheimer.de/datenschutz">
                www.mannheimer.de/datenschutz
            </a>
        </p>
        <p>Stand: Mai 2018</p>
