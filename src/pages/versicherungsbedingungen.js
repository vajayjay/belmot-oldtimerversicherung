  ...
  render() {
    return (
      <AlternativeLayout>
        <SEO
          title="FAQ"
          keywords={[`Belmot`, `Oldtimerversicherung`, `Fragen`, `Antworten`]}
        />
        <SupportSection
          h1={
            <h1>
        ...
        >
          ...
          <p>
            ...
            gesetzliche vorgeschriebenen Stand angepasst. Damit die
            Informationen immer aktuell sind, habe ich diese nicht hier
            hinterlegt, sondern stelle einen Link auf die Seite der Mannheimer
            Versicherung zur Verfügung. Insoweit ist immer Aktualität
            garantiert. Die vollständigen Versicherungsbedingungen und
